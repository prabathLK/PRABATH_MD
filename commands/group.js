...
cmd({
        ...
        async(Void, citel, text,{isCreator}) => {
            ...
            try {
                ...
                if (!users) return citel.reply(`*Please Give Me A User* ❗`);  
                citel.reply(`${users} *promoted* ✔️`);
...
cmd({
        ...
        async(Void, citel, text,{isCreator}) => {
            ...
            try {
                let users = citel.mentionedJid ? citel.mentionedJid[0] : citel.msg.contextInfo.participant || false;
                if (!users) return citel.reply(`*Please give me a user ❗*`);
		    citel.reply(`${users} *kicked out of the group!*\n\n ${text}`);
...
cmd({
        ...
        async(Void, citel, text,{isCreator}) => {
            ...
            if (!botNumber) return citel.reply(`*THIS OWNER CMD* ⛔`);
...
cmd({
        ...
        async(Void, citel, text) => {
            ...
            if (!isCreator) citel.reply(tlang().owner);
            let users = citel.mentionedJid ? citel.mentionedJid[0] : citel.msg.contextInfo.participant || false;
            citel.reply(`*Successful Blocked* ⛔`);
