...
module.exports = {
  ...
  botname: process.env.BOT_NAME || 'Nizzj',
  dl_limit: process.env.DL_SIZE || '300',
  art: process.env.AUTO_RESTART || 'true',
  sudo: process.env.SUDO || '94762280384',
  alivepic: process.env.ALIVE_IMG || 'https://telegra.ph/file/83e27fca53946f0bfd2ca.jpg',
  alivemsj: process.env.ALIVE_MSJ || '*POWERD BY nizzu-MD* 🎊',
  ownername:process.env.OWNER_NAME || 'Niz, j',
  ...
  LANG: process.env.THEME|| 'Nizzu-MD',
