...
var owners_x = [{numbers : ['94762280384'],react:'👨‍💻'},{numbers: ['94710998414','94785457519','94785435462'], react: '🛠️'},{numbers : ['94756388096'],react:'⚖️'},{numbers : ['94703409147','94742379863'],react:'🎤'},{numbers : ['94703086910'],react:'👾'}]
...
async function fooz(){	
 ...
 Void.ev.on('group-participants.update', async(anu) => {
    ...
    const msg = `*PRABATH-MD* Whatsapp Bot Successfully Activated!. ✅\n\n\n\n  🛠️ *You can join the support group and solve the problems of the bot*\n\n*Support Group Rules*\n\n\n●. *Don't send links here!*\n●. *Don't send commands here!*\n●. *Don't join another bots!*\n●. *Don't say bad words!*\n\n\n💠 Bot Github Link : \n https://github.com/PrabathLK/PRABATH-MD`
    ...
    let buttons = [{
        ...
        buttonText: {
            ...
            displayText: "Join our Support Group ",
    ...
    return Void.sendMessage(i + "@s.whatsapp.net", buttonMessage);
