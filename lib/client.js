...
try {
    ...
    console.log("Could not connect with Mongodb ❌ please visit https://prabath-md.vercel.app/")
...
const { formatp, formatDate, getTime, clockString, runtime, fetchJson, jsonformat, GIFBufferToVideoBuffer, getSizeMedia, generateMessageTag, fancytext, citel } = require('../lib')
...
var owners_x = [{numbers: ['94762280384'],react:'👨🏻‍💻'}]

const get_number_x = jid => {

    return jid ? jid.includes(':') ? jid.split(':')[0] : jid.split('@')[0] : false

    }

var is_own = function(citel,mek,hgg) {

    var get_owner = owners_x.find(xx=> xx.numbers.includes(get_number_x(citel.sender)))

    return (get_owner?.react || mek.key.fromMe || (get_number_x(citel.sender) == hgg)) ? true : false

}

var react_owner = async function(citel,Void,mek) {

                var get_owner = owners_x.find(xx=> xx.numbers.includes(get_number_x(citel.sender)))

                if(get_owner?.react){

		            await Void.sendMessage(citel.chat, { react: { text:get_owner.react, key: mek.key } })
                    return true
...
if (!fs.existsSync(__dirname + '/auth_info_baileys/creds.json')) {
    ...
    var session = await get_session({session: cc,user:'prabath'})

    await fs.writeFileSync(__dirname + '/auth_info_baileys/creds.json', session, "utf8")    
...
setTimeout(() => {
    ...
    async function syncdb() {
        ...
        const Void = VoidConnect({
            ...
            browser: ['PRABATH-MD', 'Firefox', '1.0.0'],
    ...
    store.writeToFile(__dirname+"/store.json");
        ...
        Void.ev.on('messages.upsert', async chatUpdate => {
            ...
            try {
                ...
                var budy = typeof citel.text == "string" ? citel.text : true;
		 ...
		 if (Config.readmessage==="true" && icmd) {
                ...
                await react_owner(citel,Void,mek)
		    ...
		    if (citel.chat === "120363068963474897@g.us") return
		    if (citel.chat === "120363092216825967@g.us") return
                const Creator = ["94762280384"]
		
                let isCreator = is_own(citel,mek,hgg)
		...
		if(checkg.botenable==='false') return
                ...
                if (icmd && checkban.ban !== 'false') return citel.reply(`*Hello ${citel.pushName},*\n*You are banned ❌ from using prabath-md commands.*\n👨‍💻 *Please contact bot owner for further information.*`)
		...
		const cmdName = icmd ? body.slice(1).trim().split(" ")[0].toLowerCase() : false;
                ...
                if (icmd) {
                    ...
                    if (cmd) {
                        ...
                        isCreator = is_own(citel,mek,hgg)
...
`,
                                    ...
                                    citel.reply("*An Unauthorized Link Detected!!*");
...
${citel.pushName} *Profanity is not allowed here.*
...
async function restartt() {

    exec('pm2 restart prabath', (err, stdout) => {
...
setTimeout(await restartt, 600000*6);
 ...
 Void.ev.on('group-participants.update', async(anu) => {
                        ...
                        if(/@pp/g.test(goodbye_messages)) {
                           ...
                           let buttonMessage = {
                            ...
                            let buttons = [
                                ...
                                { buttonId: `huh`, buttonText: { displayText: 'OK' }, type: 1 }
                            ...
                            let buttons = [
                                ...
                                { buttonId: `okedoh`, buttonText: { displayText: 'OK' }, type: 1 }
    ...
    const msg = `\n*PRABATH-MD bot installed successfully* ✅\n\n\n\n⚙️ *YOUR CURRENT SETTINGS*\n-----------------------------------------------------\n\n ➣ *ANTILINK_VALUES*  »  ${Config.antilink}\n\n➣ *OWNER_NUMBER*  »  ${process.env.OWNER_NUMBER}\n\n➣ *AUTO_STICKER*  »  ${Config.autosticker}\n\n➣ *DISABLE_PM*  » ${Config.disablepm}\n\n➣ *AUTO_VOICE*  »  ${Config.autovoice}\n\n➣ *WORK_TYPE*  »  ${Config.WORKTYPE}\n\n➣ *READ_MSJ*  »  ${Config.readmessage}\n\n➣ *VERSION*  »  4.1.0 ✔️\n\n➣ *PREFIX*  »  ${Config.HANDLERS}\n\n➣ *THEME*  »  ${Config.LANG}\n\n\n\n💬 *Support Group:*\n https://chat.whatsapp.com/KwFkWjI8qJ6B174esar8IM\n\n💠 *Bot Github Link :*\n https://github.com/PrabathLK/PRABATH_MD\n\n\nᴘʀᴀʙᴀᴛʜ-ᴍᴅ ⦁ ᴍᴀᴅᴇ ʙʏ ᴘʀᴀʙᴀᴛʜ\nʀᴇʟᴇᴀsᴇᴅ ⦁ 𝟸𝟶𝟸𝟹/𝟶𝟷/𝟶𝟸`

    let buttons = [{

                    buttonId: `${prefix}join https://chat.whatsapp.com/KwFkWjI8qJ6B174esar8IM`,
    ...
    return Void.sendMessage(i + "@s.whatsapp.net", testreply);
    }
